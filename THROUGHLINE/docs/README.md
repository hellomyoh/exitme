...
| [cold-start-entry-study-20260908.md](cold-start-entry-study-20260908.md) | 운영자 | 보유 0·현금만으로 시작하는 사용자의 진입 속도 검증(87개 시작·250일) — 상승·중립장 첫 체결 2~4일, 하락장 시작은 매수 정지로 중앙 78일 대기(규칙), 시가 부트스트랩은 기대 수익 −0.7%p 라 공식 유지·화면 안내만 제안 |
