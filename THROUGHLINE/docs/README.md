...
| [fast-entry-study-20260908.md](fast-entry-study-20260908.md) | 운영자 | 소량 진입(부트스트랩) 알고리즘 탐색 — 234개 조합·3 표본: 첫 10거래일 미달분 15%(하락장 7.5%) 종가 지정가 → 첫 체결 1~2일, 250일 수익 차이 ≈ 0. 채택 후보·구현 설계(ADR-010 대기) |
